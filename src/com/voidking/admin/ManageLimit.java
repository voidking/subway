...
import com.voidking.service.StopService;
 ...
 */
@WebServlet("/ManageLimit")
public class ManageLimit extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        //加载模板文件  
        Template template=config.getTemplate("manage-limit.ftl"); 
        ...
        ArrayList<Stop> stopList = stopService.stopList();
